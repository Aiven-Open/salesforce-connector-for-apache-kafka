...
public class QueryResponse {
   ...
   * Set the operation
   *
   * @param operation The operation type normally query
   */
   ...
   * Set the Object
   *
   * @param object a Salesforce object may be attached in some cases
   */
   ...
   * Set the createdById
   *
   * @param createdById The id of the person who created the operation
   */
   ...
   * Set the createdDate
   *
   * @param createdDate of when the operation was created
   */
   ...
   *
   * @param systemModstamp A modification stamp from the system
   */
   ...
   *
   * @param concurrencyMode The concurrencyMode selected
   */
   ...
   * Set the Api Version
   *
   * @param apiVersion The version of the api used to submit the query
   */
   ...
   *
   * @param errorMessage the Error message from the Bulk API
   */
