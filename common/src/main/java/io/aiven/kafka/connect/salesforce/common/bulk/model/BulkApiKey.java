...
public final class BulkApiKey implements Comparable<BulkApiKey> {
  private static final String SEGMENT_SEPARATOR =
      "/"; // can not be ':' as that is in the execution time string.
   ...
   * @param query The query that was used to return the data, this query will be automatically
   *     hashed
   * @param lastExecutionTime The execution time this query was executed at
   * @param locator The locator specifies the page of results that is being returned
   */
   ...
   *
   * @param apiName The name of the api
   * @param query The query that was used to return the data
   * @param lastExecutionTime The execution time this query was executed at
   * @param locator The locator specifies the page of results that is being returned
   * @param hashQueryString boolean to determine wether the query should be hashed can be false if
   *     already hashed
   */
  public BulkApiKey(
      String apiName,
      ...
      String locator,
      boolean hashQueryString) {
    this.apiName = apiName;
    this.queryHash =
        hashQueryString
            ? Arrays.toString(
                MurmurHash3.hash128(query.replaceAll("\\s+", "").getBytes(StandardCharsets.UTF_8)))
            : query;
   ...
   *
   * @param buildApiString the string to parse.
   ...
   *
   * @return A murmur3 hash of the original query submitted against Salesforce's api
   */
   ...
   *
   * @param other the BulkApiKey to be compared.
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(lastExecutionTime, that.lastExecutionTime)
