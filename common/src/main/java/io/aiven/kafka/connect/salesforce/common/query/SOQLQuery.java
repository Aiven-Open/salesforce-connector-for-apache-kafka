...
/**
 * This class allows the deconstruction and reconstruction of a SOQL query for
 * use in the querying of data. Allows better control and validation of SOQL
...
public class SOQLQuery {
	...
	private static final List<String> SUPPORTED_KEYWORDS = List.of(SELECT, FROM, WHERE, HAVING, ORDER_BY, GROUP_BY,
			LIMIT, OFFSET, WITH);
	 ...
	 * 
	 * @return Get the original SOQL query string that was used to create this
	 *         object
	 */
	 ...
	 * 
	 * @param SOQLQuery
	 *            The original SOQL query that was supplied to create this Object
	 */
	...
	/**
	 * Generates a SOQL query string that can be used to retrieve information from
	 * Salesforce through the bulk api. Ordering of SOQL query construction aligns
	 * with Salesforce documentation <a href=
	 ...
	 *            The lastModifiedDate for the object to begin querying data from
	...
	/**
	 * Validates that the SOQL query meets the expectations of the connector for it
	 * to be able to track offsets correctly
	 * 
	 * @return True if valid SOQL query for this connector, False if not valid for
	 *         this connector
	 */
	 ...
	 * 
	 * @param queryString
	 *            An original SOQL query
	 * @return An SOQLQuery Object
	 */
	public static SOQLQuery fromQueryString(String queryString) {
		return populateSOQLQuery(new SOQLQuery(), queryString.split("(" + buildSOQLQueryRegex() + ")"), queryString);
	}

	/**
	 *
	 * @param query
	 *            The SOQLQuery Object
	 * @param soqlQueryParts
	 *            The individual parts of the SOQL query broken by the supported
	 *            tokens
	 * @param queryString
	 *            The original SOQL query String provided
	 * @return A fully populated SOQL Query Object
	 */
	private static SOQLQuery populateSOQLQuery(SOQLQuery query, String[] soqlQueryParts, String queryString) {
