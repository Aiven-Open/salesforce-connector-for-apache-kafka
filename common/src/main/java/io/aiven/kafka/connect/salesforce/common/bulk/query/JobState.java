...
/**
 * The State of the Bulk API 2.0 Query Job states as described in the documentation, in addition
 * there is a `Submitted` and a 'fulfilled' state used internally in the connector.
...
public enum JobState {
   ...
   *
   * <p>(Query) The job is ready to be processed.
   */
  UploadComplete("UploadComplete"),
  /**
   * The job is being processed by Salesforce. Operations include automatic, optimized batching or
   * chunking of job data, and processing of job operations.
   */
  InProgress("InProgress"),
  /**
   * The job was canceled by the job creator, or by a user with the “Manage Data Integrations”
   * permission. It should be deleted
   */
  Aborted("Aborted"),
   ...
   *
   * @param value The string version of the Enum value
  ...
  public boolean isExecuting() {
    return this.equals(InProgress) || this.equals(Submitted) || this.equals(UploadComplete);
  }
}
