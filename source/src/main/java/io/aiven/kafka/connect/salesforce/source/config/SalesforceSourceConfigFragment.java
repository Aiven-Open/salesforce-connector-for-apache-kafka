...
public final class SalesforceSourceConfigFragment extends ConfigFragment {
  ...
  /**
   * The String list of queries separated by a semicolon to distinguish between individual queries,
   * it can be null if not sing the bulk api
   */
  ...
  /**
   * Update the configuration with the options for the Salesforce source connector.
   *
  ...
  public static final class Setter extends AbstractFragmentSetter<Setter> {
     ...
     *
     * @param salesforceBulkApiQueries The queries to be made against the Bulk Api delimitated by a
     *     semicolon
